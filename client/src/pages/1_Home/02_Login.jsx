...
const Login = () => {
  ...
  return (
    <div
      className={loading ? "col-8 signup-container-loading" : "col-8"}
        ...
        >
          <div className="full-input w-50 m-2">
            <label htmlFor="email" placeholder="Email">
              ...
              <Tooltip
                arrow
                title="Students are advised to use their Institute Email IDs"
                placement="top"
              >
          ...
          <button
            ...
            className="btn btn-dark btn-lg w-25 mt-2 px-2"
          >
            Login
          </button>
