...
export default function Home() {
  ...
  const handleClick1 = (e) => {
    if (sign.password !== sign.cpassword) {
      ...
      setLoading(true);
      axios
        .post(`${host}/api/register/student/basic/`, {
          name: name,
  ...
  const handleClick2 = (e) => {
    ...
    const email =
      entry_number.slice(4, 7).toLowerCase() +
      entry_number.slice(2, 4) +
      entry_number.slice(7, 11) +
      "@iitd.ac.in";
    const host = "http://10.17.50.150/backend";
    setLoading(true);
    axios
  ...
  const handleClick4 = (e) => {
    ...
    setLoading(true);
    axios
      .post(`${host}/api/register/student/additional/`, formData, {
        headers: {
      ...
      .catch(function (error) {
        ...
        if (error.response.data === "Profile already exists") {
          ...
          alert(
            "You are not registered as a student. Please register as a student."
          );
          navigate("/");
              ...
              >
                ...
                <button
                  ...
                  disabled={
                    ...
                    !validEntryNumber.test(sign.entry_number)
                  }
          ...
          <div className="col-8">
            ...
            >
              ...
              <p>
                ...
                {sign.entry_number.slice(4, 7).toLowerCase() +
                  sign.entry_number.slice(2, 4) +
                  sign.entry_number.slice(7, 11) +
                  "@iitd.ac.in"}
              </p>
              <form
          ...
          <div className="col-8">
            ...
            >
              ...
              <div className="form-wrapper d-flex flex-column justify-content-center align-items-center">
                ...
                <small>
                  (Note that this would be officially verified. Any discrepency
                  may attract penalty)
                </small>
              </div>
              ...
              <div className="form-wrapper d-flex flex-row justify-content-center align-items-center">
                ...
                >
                  ...
                  <label className="form-check-label py-2" htmlFor="checkbox">
                    B.Tech
                  </label>
                </div>
                <div
              ...
              <div className="form-wrapper d-flex flex-column justify-content-center align-items-center">
                <div className="d-flex">
                  ...
                  <button
                    type="submit"
                    disabled={sign.cgpa.length < 1 || sign.program.length < 1}
                    className="btn btn-lg btn-dark my-4 mx-2"
                  >
                    Next
                  </button>
        ...
        <div className="row">
          ...
          <div className="col-8">
            ...
            >
              <h3>Additional Details</h3>
              <form
                onSubmit={handleClick4}
                className="form-wrapper d-flex flex-column justify-content-center align-items-center"
              >
                <div className="full-input m-2">
                  <label htmlFor="resume" placeholder="resume">
                    Upload Resume*
                  </label>
                  <input
                    type="file"
                ...
                <div className="full-input m-2">
                  <label
                    htmlFor="academic_transcript"
                    placeholder="academic_transcript"
                  >
                    Upload Latest Academic Transcript*
                  </label>
                  <input
                    type="file"
                ...
                <div className="d-flex">
                  ...
                  <button
                    type="submit"
                    disabled={
                      sign.academic_transcript === null || sign.resume === null
                    }
                    className="btn btn-lg btn-dark my-4 mx-2"
                  >
                    Finish
