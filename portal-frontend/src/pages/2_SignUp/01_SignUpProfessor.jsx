...
export default function Home() {
    ...
    const [sign, setSign] = useState({ name: "", email: "", password: "", cpassword: "", university: "", department: "", designation: "", contact_email: "", website: "" })
    ...
    const handleClick1 = (e) => {
        if (sign.password !== sign.cpassword) {
            ...
            setLoading(true)
            axios.post(`${host}/api/register/professor/basic/`, {
                "name": name,
                "email": email,
                "password": password
            }).then(function () {
    ...
    const handleClick3 = (e) => {
        e.preventDefault()
        const { email, university, department, website, contact_email, designation } = sign;
        const host = "http://10.17.50.150/backend";
        setLoading(true)
        axios.post(`${host}/api/register/professor/additional/`, {
            "email": email,
            ...
            if (error.response.data === "Profile already exists") {
                ...
                alert("You are not registered as a professor. Please register as a professor.")
                navigate('/')
        ...
        <div className={loading ? "text-center signup-container signup-container-loading" : "text-center signup-container"}>
                    ...
                    <div className="col-8" style={{ paddingTop: "100px" }}>
                        <div className="container-screen">
                            ...
                            <form onSubmit={handleClick1} className="form-wrapper d-flex flex-column justify-content-center align-items-center">
                                ...
                                <button type='submit' disabled={sign.name.length < 1 || sign.password.length < 6 || sign.email.length < 1 || sign.password !== sign.cpassword} className="btn btn-dark btn-lg w-50 mt-5" >Next</button>
                            </form>
                        </div>
                    </div>
                </div>}
            {page === 2 &&
                <div className="row" >
                    ...
                    <div className="col-8">
                        <form onSubmit={handleClick2} className="container-screen my-5" style={{ paddingTop: "100px" }}>
                            ...
                            <div className="form-wrapper d-flex flex-column justify-content-center align-items-center">
                                ...
                                <button className='btn btn-lg btn-dark my-3' onClick={handleVerifyEmail}>Resend Email</button>
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="container-screen mt-5" style={{ paddingTop: "100px" }}>
                            ...
                            <form onSubmit={handleClick3} className="form-wrapper d-flex flex-column justify-content-center align-items-center" >
                                <div className='full-input w-50 m-2'>
                                    <label htmlFor="university" >Institute*</label>
                                    <input onChange={handleChange} type="text" name="university" value={sign.university} placeholder='Eg: XYZ Institute of Technology' />
                                </div>
                                <div className='full-input w-50 m-2'>
                                    <label htmlFor="department">Department*</label>
                                    <input onChange={handleChange} type="text" name="department" value={sign.department} placeholder='Eg: Computer Science and Engineering' />
                                </div>
                                <div className='full-input w-50 m-2'>
                                    <label htmlFor="designation" >Designation*</label>
                                    <input onChange={handleChange} type="text" name="designation" value={sign.designation} placeholder='Eg: Assistant Professor' />
                                </div>
                                <div className='full-input w-50 m-2'>
                                    <label htmlFor="contact_email" >Alternate Email (Optional)</label>
                                    <input onChange={handleChange} type="text" name="contact_email" value={sign.contact_email} />
                                </div>
                                <div className='full-input w-50 m-2'>
                                    <label htmlFor="website" >Website (Optional)</label>
                                    <input onChange={handleChange} type="text" name="website" value={sign.website} placeholder='Eg: https://prof.xyz.edu' />
                                </div>
                                <div className='d-flex'>
                                    <button type='submit' disabled={sign.department.length<1 || sign.designation.length<1 || sign.university.length<1 } className='btn btn-lg btn-dark my-4 mx-2' >Finish</button>
                                </div>
                            </form>
                        </div>
                    </div>
